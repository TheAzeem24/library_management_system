 ...
 *@return res:int
 */
public class BookTittleComapare implements Comparator
{
	...
	public int compare(Object o1, Object o2)
	{
		Book book1 = (Book)o1;
		Book book2 = (Book)o2;
		String tittle1 = book1.getBookTittle();
		String tittle2 = book2.getBookTittle();
		int res = tittle1.compareTo(tittle2);
		return res;
	}
